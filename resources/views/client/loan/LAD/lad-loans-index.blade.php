...
<form action="{{ url('/lad-loans') }}" method="POST" enctype="multipart/form-data" class="this-form">
    <div class="content-form-page">
        ...
        <div class="row">
            <div class="header-text">
              ...
              <h2 style="font-weight: 900; text-align: center; font-size: .4in; padding: 20px 0">LAD Loan Application Form</h2>
        ...
        <input type="hidden" name="loan_type" value="LAD">
